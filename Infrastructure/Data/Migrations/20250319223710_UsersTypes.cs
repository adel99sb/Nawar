        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminPosition = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Professors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Professors_AppUsers_Id",
                        column: x => x.Id,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UniversityNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    HighSchoolScore = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[UniversityNumber] IS NOT NULL");
        }
